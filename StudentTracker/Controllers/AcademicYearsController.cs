    ...
    public class AcademicYearsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (!res.IsSuccessStatusCode)
                return View(new List<AcademicYearView>());
        ...
        public async Task<IActionResult> Create(AcademicYearView model)
        {
            ...
            var res = await _client.PostAsync($"{_apiBase}AcademicYears", content);
            ...
            TempData["Msg"] = "Academic year created successfully.";
        ...
        public async Task<IActionResult> Edit(int id, AcademicYearView model)
        {
            ...
            var content = new StringContent(payload, Encoding.UTF8, "application/json");
            var res = await _client.PutAsync($"{_apiBase}AcademicYears/{id}", content);
